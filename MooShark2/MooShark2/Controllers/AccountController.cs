...
namespace MooShark2.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginViewModel model, string returnUrl)
        {
            ...
            else if (LoginService.Validate(model.Email, model.Password))
            {
                Session["User"] = Session.SessionID;
                HttpContext.Session["User"] = Session.SessionID;
                LoginService.Login(model.Email, Session["User"].ToString());
        ...
        {
            AccountHelper.removeAccountSession(HttpContext.Session["User"].ToString());
            Session["User"] = null;
